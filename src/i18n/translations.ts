...
type TranslationKeys = {
  ...
  events_page_title_1: string;
  events_page_title_2: string;
...
export const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    amb_label: "Brand Ambassadors",
    amb_title_1: "Meet Our",
    amb_title_2: "Champions",
    amb_subtitle: "South Africa's biggest artists backing the grassroots betting movement",
    amb_cta: "Join the Tour & Bet Now",

    events_label: "Events & Tours",
    events_title_1: "Kasi",
    events_title_2: "Events",
    events_subtitle: "Festivals, tavern challenges, and tours — bet on the action, live the culture",
    events_cta: "Bet & Win Tickets",
    events_view_all: "View All Events",
    events_page_title_1: "eKasiBets",
    events_page_title_2: "Events & Tours",
    events_page_subtitle: "From township festivals to ambassador tours — experience eKasi culture and bet on the action",
    events_upcoming: "All Upcoming Events",
    events_bet: "Bet Now",
  },
  ...
  zu: {
    ...
    why_subtitle: "Asiyona enye i-app yokubheja. Singomakhelwane bakho, umphakathi wakho, umlingani wakho wokunqoba.",
    why_built: "Yakhelwe eKasi",
    why_built_desc: "Siyakuqonda ukuphila kwaselokishini. Bheja kumadabi endawo, sekela amaqembu akho.",
    why_fast: "Ukukhokhwa Okusheshayo",
    why_fast_desc: "Ungalindi izinsuku. Khokhwa ngqo ku-akhawunti yakho ngeminithi.",
    why_community: "Ukuqhutshwa Umphakathi",
    why_community_desc: "Sibuyisela emuva. Ingxenye yayo yonke ibheja isekela ukuthuthukiswa kwebhola.",
    ...
    township_subtitle: "Kusukela emigwaqeni yothuli kuya ezinkundleni ezinkulu",
    ...
    how_subtitle: "Akukho ukubhalisa okuyinkimbinkimbi. Akukho izimali ezifihliwe.",
    how_step1: "Dala I-Akhawunti",
    how_step1_desc: "Bhalisa ngaphansi kwemizuzwana engu-60. Inombolo yakho yefoni kuphela.",
    how_step2: "Beka Ibheja Yakho",
    how_step2_desc: "Khetha kumadlalo asekasi noma kumadlalo amazwe ngamazwe.",
    how_step3: "Khokhwa Ngokushesha",
    how_step3_desc: "Uwine? Imali yakho ifika ku-akhawunti yakho ngeminithi.",
    ...
    resp_subtitle: "Ukubheja kufanele kujabulise. Sizibophezele ukukusiza ulawule.",
    ...
    footer_cta_sub: "Joyina abaseNingizimu Afrika abangu-50,000+ ababheji ne-eKasibets",
    footer_cta_btn: "Qala Mahhala",
    footer_brand_desc: "I-platform yokuqala yase-township eNingizimu Afrika.",
    ...
    community_subtitle: "Xhumana nababheji abanye, yabelana ngokuwina",
    ...
    amb_label: "Ama-Ambassador Ebhrandi",
    amb_title_1: "Hlangana Ne",
    amb_title_2: "Zintshatsheli",
    amb_subtitle: "Abaculi abakhulu baseNingizimu Afrika abasekela umnyakazo wokubheja wasekasi",
    amb_cta: "Joyina Itour & Ubheje Manje",

    events_label: "Imicimbi & Ama-Tour",
    events_title_1: "Imicimbi",
    events_title_2: "YaseKasi",
    events_subtitle: "Ama-festival, ama-tavern challenge, nama-tour — bheja esenzweni, uphile isiko",
    events_cta: "Bheja & Uwine Amathikithi",
    events_view_all: "Buka Yonke Imicimbi",
    events_page_title_1: "eKasiBets",
    events_page_title_2: "Imicimbi & Ama-Tour",
    events_page_subtitle: "Kusukela kuma-festival aselokishini kuya kuma-tour ama-ambassador — phila isiko saseKasi ubheje esenzweni",
    events_upcoming: "Yonke Imicimbi Ezayo",
    events_bet: "Bheja Manje",
  },
  ...
  xh: {
    ...
    hero_title_1: "Bheja eKasi.",
    hero_title_2: "Wina Kakhulu.",
    hero_subtitle: "Iqonga lokuqala lasetawunishipi eMzantsi Afrika — iintlawulo ezikhawulezayo, imidlalo yendawo. Yakhelwe eKasi! 🇿🇦",
    ...
    why_community_desc: "Sibuyisela emva. Inxalenye yayo yonke ibheja ixhasa uphuhliso lwebhola.",
    why_active: "Ababheji Abasebenzayo",
    ...
    how_subtitle: "Akukho kubhalisa kuyinkimbinkimbi. Akukho mivuzo efihliweyo.",
    how_step1: "Dala I-Akhawunti",
    ...
    footer_brand_desc: "Iqonga lokuqala lasetawunishipi loMzantsi Afrika.",
    ...
    amb_title_1: "Hlangana Ne",
    amb_title_2: "Zintshatsheli",
    amb_subtitle: "Abona baculi beMzantsi Afrika baxhasa umnyakazo wokubheja wasekasi",
    amb_cta: "Joyina Itour & Ubheje Ngoku",

    events_label: "Imicimbi & Iitoure",
    events_title_1: "Imicimbi",
    events_title_2: "YaseKasi",
    events_subtitle: "Iifestivali, iimpengo zetaveni, neetoure — bheja kwisenzo, phila inkcubeko",
    events_cta: "Bheja & Uwine Amatikiti",
    events_view_all: "Jonga Yonke Imicimbi",
    events_page_title_1: "eKasiBets",
    events_page_title_2: "Imicimbi & Iitoure",
    events_page_subtitle: "Ukusuka kwiifestivali zaselokishini ukuya kwiitoure zama-ambassador",
    events_upcoming: "Yonke Imicimbi Ezayo",
    events_bet: "Bheja Ngoku",
  },
  ...
  af: {
    ...
    hero_subtitle: "Suid-Afrika se township-eerste wedplatform — vinnige uitbetalings, plaaslike speletjies. Gebou vir eKasi! 🇿🇦",
    ...
    township_subtitle: "Van die stofstrate tot die groot stadions",
    ...
    how_subtitle: "Geen ingewikkelde registrasie. Geen versteekte fooie.",
    how_step1: "Skep 'n Rekening",
    how_step1_desc: "Registreer in minder as 60 sekondes. Net jou foonnommer.",
    how_step2: "Plaas Jou Weddenskap",
    how_step2_desc: "Kies uit plaaslike kasi-speletjies of internasionale wedstryde.",
    how_step3: "Word Kits Betaal",
    how_step3_desc: "Gewen? Jou geld tref jou rekening binne minute.",
    ...
    footer_brand_desc: "Suid-Afrika se premier township-eerste wedplatform.",
    ...
    amb_label: "Handelsmerk Ambassadeurs",
    amb_title_1: "Ontmoet Ons",
    amb_title_2: "Kampioene",
    amb_subtitle: "Suid-Afrika se grootste kunstenaars ondersteun die voetsoldate-wedbeweging",
    amb_cta: "Sluit aan by die Toer & Wed Nou",

    events_label: "Geleenthede & Toere",
    events_title_1: "Kasi",
    events_title_2: "Geleenthede",
    events_subtitle: "Feeste, tavern-uitdagings, en toere — wed op die aksie, leef die kultuur",
    events_cta: "Wed & Wen Kaartjies",
    events_view_all: "Sien Alle Geleenthede",
    events_page_title_1: "eKasiBets",
    events_page_title_2: "Geleenthede & Toere",
    events_page_subtitle: "Van township-feeste tot ambassadeurstoere — beleef eKasi-kultuur en wed op die aksie",
    events_upcoming: "Alle Komende Geleenthede",
    events_bet: "Wed Nou",
  },
};