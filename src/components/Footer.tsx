  ...
  return (
    <footer className="bg-background border-t border-border/50">
          ...
          <div className="glass p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Join 50,000+ South Africans betting smarter with eKasibets
              </p>
            </div>
            <button className="btn-premium py-4 px-8 flex items-center gap-2">
              Get Started Free
              <ArrowRight size={18} />
            </button>
          </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm mb-5 leading-relaxed">
              South Africa's premium township-first betting platform. Bet local, win local.
            </p>
        ...
        <div className="border-t border-border/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">
            © {currentYear} eKasibets. All rights reserved. Licensed by the SA Gaming Board.
          </p>
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <span>🇿🇦</span>
            <span>Made with pride in South Africa</span>
          </div>
        </div>
      </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-2xl shadow-lg hover:scale-110 transition-transform"
      >
